		...
		video_err_h *errh, void *arg)
{
	...
	//CHChen59: check local video souce. If video source is NULL, set stream direct to receive only 
	if (vidsrc_find(baresip_vidsrcl(), NULL) == NULL)
		stream_set_ldir(v->strm, SDP_RECVONLY);
