...
static int encode(struct auenc_state *st, bool *marker, uint8_t *buf,
		       size_t *len, int fmt, const void *pv_sampv, size_t sampc)
{
	const size_t n = st->channels * st->frame_size;
	int ret, r;
	int16_t *sampv = (int16_t *)pv_sampv;
...
static int decode(struct audec_state *st, int fmt, void *pv_sampv,
...
#if 0
	/* Stereo Speex */
	{LE_INIT, 0, "speex", 32000, 32000, 2, 2, SPEEX_PTIME, speex_fmtp_wb,
	 encode_update, encode, decode_update, decode, pkloss, 0, 0},
	{LE_INIT, 0, "speex", 16000, 16000, 2, 2, SPEEX_PTIME, speex_fmtp_wb,
	 encode_update, encode, decode_update, decode, pkloss, 0, 0},
	{LE_INIT, 0, "speex",  8000,  8000, 2, 2, SPEEX_PTIME, speex_fmtp_nb,
	 encode_update, encode, decode_update, decode, pkloss, 0, 0},
#endif

	/* Standard Speex */
	{LE_INIT, 0, "speex", 32000, 32000, 1, 1, SPEEX_PTIME, speex_fmtp_wb,
	 encode_update, encode, decode_update, decode, pkloss, 0, 0},
	{LE_INIT, 0, "speex", 16000, 16000, 1, 1, SPEEX_PTIME, speex_fmtp_wb,
	 encode_update, encode, decode_update, decode, pkloss, 0, 0},
	{LE_INIT, 0, "speex",  8000,  8000, 1, 1, SPEEX_PTIME, speex_fmtp_nb,
	 encode_update, encode, decode_update, decode, pkloss, 0, 0},
};
